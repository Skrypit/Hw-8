...
public class MyHashMap<K, V> {
    ...
    public void put(K key, V value) {
        ...
        if (head == null || head.getKey() == newNode.getKey()) {
            head = newNode;
            ...
            while (last.getNext() != null) {
                last = last.getNext();
                if (last.getKey() == newNode.getKey()) {
                    last.setValue(newNode.getValue());
                }
    ...
    public V get(K key) {
        ...
        if (head == null) {
            ...
            while (request.getKey() != key && request.getNext() != null) {
...
class MyHashMapTest {
    ...
    public static void main(String[] args) {
        ...
        carsPricesHashMap.put("BMW X5", 256_000);//дублікат
        carsPricesHashMap.put("Volvo S80", 9000);
        carsPricesHashMap.put("Lada Largus", 2000);
        carsPricesHashMap.put("Lada Largus", 4000); //дублікат
        ...
        System.out.println("carsPricesHashMap.get(Another key) = " + carsPricesHashMap.get("ZAZ"));
        ...
        System.out.println("carsPricesHashMap.size() = " + carsPricesHashMap.size());
        carsPricesHashMap.get("Volvo S80");
    }
}
